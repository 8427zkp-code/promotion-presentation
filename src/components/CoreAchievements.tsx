                ...
                <div className="flex-1 space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed">
                      ...
                      {index === 1 && "验证「高频刚需工具从体验优化→用户增长→商业放大」的全链路打法，沉淀可复制的工具型产品增长变现方法论。"}
                ...
                <div className="md:w-2/5 space-y-4 pt-10">
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
                      ...
                      {index === 1 && (
                        <>
                          <li>AI技术迭代快 → 快速学习前沿技术，落地GAN版、GAN+SD融合消除</li>
                          <li>用户场景分散、认知度低 → 锁定「去水印/去文字」核心场景，上线专属功能+全路径引导</li>
                        </>
                      )}
                      {index === 2 && (
                        <>
                          <li>独立工具入口难找 → 复用AI消除打法，新增AI消除/变清晰等高价值功能，搭建全路径曝光体系</li>
